...
function CreateIssue() {
    ...
    return (
        <div>
            <form noValidate onSubmit={handleSubmit} ref={IssueFormRef}>
                                                        ...
                                                        <Select
                                                            ...
                                                            value={
                                                                issueDetails?.newIssue?.category ?
                                                                    {
                                                                        value: issueDetails?.newIssue?.category, label: issueDetails?.newIssue?.category
                                                                    } : null}
                                                ...
                                                <div className="col-md-9">
                                                    <div className="input-group input-group-static mb-4">
                                                        ...
                                                        <input
                                                            ...
                                                            name="location"
                                                            onChange={handleIputChange}
                                                            value={issueDetails?.newIssue?.photos}
                                                        />
                                                        <div
                                                            className="form-text text-secondary"
                                                            id="basic-addon4"
