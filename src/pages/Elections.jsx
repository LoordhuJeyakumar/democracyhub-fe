            ...
            <div className="card" id="general-elections">
              ...
              <div className="card-body">
                <p>
                  ...
                  the People, are held every five years in India. These
                  elections are conducted by the Election Commission of India to
                  elect 543 members to the Lok Sabha
                </p>
                <p>
                  The Lok Sabha is the lower house of the Parliament of India,
                  and its members represent constituencies from different parts
                  of the country. The party or coalition that secures a majority
                  of seats in the Lok Sabha forms the government, and its leader
                  typically becomes the Prime Minister
                </p>
              </div>
            </div>
            <div className="card">
                ...
                <ul className="timeline">
                    ...
                    <div className="direction-r">
                      ...
                      <div className="desc">
                        <p>
                          ...
                          <b>June 1</b>. covering 57 parliamentary
                          constituencies across eight states.
                        </p>
                        <p className="p-2">
                          Polling status :{" "}
                  ...
                  <li>
                    <div className="direction-l">
                      ...
                      <div className="desc">
                        <p>
                          The sixth phase of polling will be held on{" "}
                          <b>May 25</b>, covering 57 parliamentary
                          constituencies across seven states.
                        </p>
                        <p className="p-2">
                          Polling status :{" "}
                          <span className="badge bg-primary">Scheduled</span>
                  ...
                  <li>
                    <div className="direction-r">
                      ...
                      <div className="desc">
                        <p>
                          {" "}
                          The fifth phase of polling will be held on{" "}
                          <b>May 20</b>, covering 49 parliamentary
                          constituencies across eight states.
                        </p>
                        <p className="p-2">
                          Polling status :{" "}
                    ...
                    <div className="direction-l">
                      ...
                      <div className="desc">
                        <p>
                          ...
                          <b>May 13</b>, covering 96 parliamentary
                          constituencies across 10 states.
                        </p>
                        <p className="p-2">
                          Polling status{" "}
                  ...
                  <li>
                    <div className="direction-r">
                      ...
                      <div className="desc">
                        <p>
                          The third phase of polling will be held on{" "}
                          <b>May 7</b>, covering 94 parliamentary constituencies
                          across 12 states.
                        </p>
                        <p className="p-2">
                          Polling status{" "}
                  ...
                  <li>
                    <div className="direction-l">
                      ...
                      <div className="desc">
                        <p>
                          The second phase of polling was held on{" "}
                          <b>April 26</b>, covering 89 parliamentary
                          constituencies across 13 states.
                        </p>
