...
function IssuesCardSide({ eachIssue, selectedIssue, setIsActive, setSelectedIssue, key }) {
    return (
        <div className="col-lg-3 overflow-scroll vh-100 card-list" key={key}>
