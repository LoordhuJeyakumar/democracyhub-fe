          ...
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
              <li className="breadcrumb-item text-sm">
                <a className="opacity-3 text-white" href="/dashboard">
                  <svg
                    width="12px"
                    height="12px"
                    className="mb-1"
              ...
              <li className="breadcrumb-item text-sm">
                <a className="opacity-5 text-white" href="/dashboard">
                  Pages
                </a>
              </li>
              <li
                className="breadcrumb-item text-sm active text-white text-capitalize"
                aria-current="page"
              >
                dashboard
              </li>
